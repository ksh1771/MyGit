...
ExecStep xelab -m64 --debug typical --relax -L work -L unisims_ver -L unimacro_ver -L secureip --snapshot tp_gen_tb_behav --prj E:/projects/tp_gen_2015_feb/tp_gen_2015-2.sim/sim_1/behav/tp_gen_tb.prj   work.tp_gen_tb   work.glbl
